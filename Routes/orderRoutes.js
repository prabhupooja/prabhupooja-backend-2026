...
router.get('/getOrderId/:orderId', AdminOrAgentVerifyToken, orderController.getByOrderId);
router.get('/count-order-id/:orderId', AdminOrAgentVerifyToken, orderController.getByOrderId);
router.get('/count-order-id/:orderId/:merchantId', AdminOrAgentVerifyToken, orderController.getByOrderId);
